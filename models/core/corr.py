...
def bilinear_sampler_raft_stereo(img, coords, mode='bilinear', mask=False, stereo=True):
...
class CorrBlock1D:
    ...
    def __call__(self, flow):
        ...
        for i in range(self.num_levels):
            ...
            # print('1d corr coords_lvl', corr.shape, coords_lvl.shape)
            corr = bilinear_sampler_raft_stereo(corr, coords_lvl)
